...
#define col1 5 /* Number of columns of first matrix */
#define row2 5 /* Number of rows of second matrix */
...
int main()
{
    int a[row1][col1] = {{1,2,3,4,5}, {4,5,6,7,8},{6,7,8,9,1},{2,3,5,4,5}};
    int b[row2][col2] = {{1,2,3,4}, {4,5,2,3}, {8,9,10,11},{4,3,5,2},{5,4,7,8}};
    int c[row1][col2];
    int *d,*e,*f;
    int i,j;
